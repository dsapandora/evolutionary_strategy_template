...
def evolve_env(env, policy_f, te, perturb_f, combine_f, alpha=1, trials=20, spawn=100, stages=100, verbosity=1, render=True, max_steps=1000, print_every=20, eval_trials=1):
